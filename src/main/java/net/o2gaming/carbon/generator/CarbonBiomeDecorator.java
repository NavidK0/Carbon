...
public class CarbonBiomeDecorator extends BiomeDecorator {
    ...
    public CarbonBiomeDecorator() {
        ...
        this.h = new CarbonWorldGenMinable(Blocks.DIRT, 32);
        this.i = new CarbonWorldGenMinable(Blocks.GRAVEL, 32);
        this.j = new CarbonWorldGenMinable(Blocks.COAL_ORE, 16);
        this.k = new CarbonWorldGenMinable(Blocks.IRON_ORE, 8);
        this.l = new CarbonWorldGenMinable(Blocks.GOLD_ORE, 8);
        this.m = new CarbonWorldGenMinable(Blocks.REDSTONE_ORE, 7);
        this.n = new CarbonWorldGenMinable(Blocks.DIAMOND_ORE, 7);
        this.o = new CarbonWorldGenMinable(Blocks.LAPIS_ORE, 6);
