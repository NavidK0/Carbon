...
public class CarbonWorldGenMinable extends WorldGenerator {

    private Block a;
    private int b;
    private Block c;

    public CarbonWorldGenMinable(Block block, int i) {
        this(block, i, Carbon.injector.stoneBlock);
    }

    public CarbonWorldGenMinable(Block block, int i, Block block1) {
        this.a = block;
        this.b = i;
        this.c = block1;
    }
