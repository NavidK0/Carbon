...
public class PerfIntegerMonitor extends AbstractMonitor implements IntegerMonitor {
	 ...
	 *
	 * @param name
	 *            the name of the integer instrument
	 * @param u
	 ...
	 * @param ib
	 *            the buffer containing the integer instrument data.
	 */
	...
	/**
	 * {@inheritDoc} The object returned contains an Integer object containing the current value of the IntegerInstrument.
	 *
	 * @return Object - the current value of the the IntegerInstrument. The return type is guaranteed to be of type Integer.
	 */
