...
/**
 * The concrete PerfDataBuffer implementation for the <em>rmi:</em> protocol for the HotSpot PerfData monitoring implementation.
 * <p>
...
public class PerfDataBuffer extends AbstractPerfDataBuffer {
	 ...
	 *
	 * @param rvm
	 *            the proxy to the remote MonitredVm object
	 * @param lvmid
	 *            the local Java Virtual Machine Identifier of the remote target.
	 *
	 ...
	 *
	 * @param buffer
	 *            the buffer to receive the copy of the remote instrumentation buffer.
