...
public class MonitoredHostProvider extends MonitoredHost {
	 ...
	 * {@inheritDoc}.
	 * <p>
	 * Note - the <em>file:</em> protocol silently ignores the <tt>interval</tt> parameter.
	 */
	 ...
	 * {@inheritDoc}.
	 * <p>
	 * Note - the <em>file:</em> protocol currenly does not support registration or notification of event listeners. This method silently ignores the add request.
	 */
	 ...
	 * {@inheritDoc}.
	 * <p>
	 * Note - the <em>file:</em> protocol currenly does not support registration or notification of event listeners. This method silently ignores the remove request.
	 */
	 ...
	 * {@inheritDoc}.
	 * <p>
	 * Note - the <em>file:</em> protocol currently does not support the notion of tracking active or inactive Java Virtual Machines. This method currently returns an empty set.
	 */
