...
public class MonitorStructureException extends MonitorException {
	...
	/**
	 * Constructs an <code>MonitorStructureException</code> with the specified detail message. The error message string <code>s</code> can later be retrieved by the <code>{@link java.lang.Throwable#getMessage}</code> method of class <code>java.lang.Throwable</code>.
	 *
	 * @param s
	 *            the detail message.
	 */
