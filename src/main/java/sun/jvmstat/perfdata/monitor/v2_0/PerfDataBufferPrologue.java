...
public class PerfDataBufferPrologue extends AbstractPerfDataBufferPrologue {
	 ...
	 * 
	 * note that PERFDATA_PROLOG_ACCESSIBLE_OFFSET redefines PERFDATA_PROLOG_RESERVEDB1_OFFSET from AbstractPerfDataBufferPrologue.
	 */
	 ...
	 *
	 * @return IntBuffer - a ByteBuffer that accesses the used value in the instrumentation buffer header.
	 * @see #getUsed()
	 */
	 ...
	 *
	 * @return IntBuffer - a ByteBuffer that accesses the size value in the instrumentation buffer header.
	 * @see #getBufferSize()
	 */
	 ...
	 *
	 * @return IntBuffer - a ByteBuffer that accesses the overflow value in the instrumentation buffer header.
	 * @see #getOverflow()
	 */
	 ...
	 *
	 * @return LongBuffer - a ByteBuffer that accesses the modification time stamp value in the instrumentation buffer header.
	 ...
	 *
	 * @return LongBuffer - a ByteBuffer that accesses the num_entries value in the instrumentation buffer header.
	 * @see #getNumEntries()
	 */
