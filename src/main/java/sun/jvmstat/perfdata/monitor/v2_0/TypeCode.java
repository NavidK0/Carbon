...
public class TypeCode {
	 ...
	 * @return TypeCode - The TypeCode enumeration object for the given character.
	 * @throws IllegalArgumentException
	 *             Thrown if <code>c</code> is not a valid Java TypeCode.
	 */
	 ...
	 *
	 * @param b
	 *            a byte representing a Java TypeCode. This value is converted into a char and used to find the corresponding TypeCode.
	 * @return TypeCode - The TypeCode enumeration object for the given byte.
	 * @throws IllegalArgumentException
	 *             Thrown if <code>v</code> is not a valid Java TypeCode.
	 */
