 ...
 *
 * This class is provided to support the PerfStringMonitor classes. Instrumentation objects of this direct type currently cannot be created or monitored.
 *
...
public class PerfByteArrayMonitor extends AbstractMonitor implements ByteArrayMonitor {
	...
	/**
	 * {@inheritDoc} The object returned contains a byte[] with a copy of the current elements of the ByteArrayInstrument.
	 *
