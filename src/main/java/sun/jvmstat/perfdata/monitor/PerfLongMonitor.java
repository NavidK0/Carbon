...
public class PerfLongMonitor extends AbstractMonitor implements LongMonitor {
	 ...
	 *
	 * @param name
	 *            the name of the long instrument
	 * @param u
	 ...
	 * @param lb
	 *            the buffer containing the long instrument data.
	 */
	...
	/**
	 * {@inheritDoc} The object returned contains a Long object containing the current value of the LongInstrument.
	 *
	 * @return Object - the current value of the the LongInstrument. The return type is guaranteed to be of type Long.
	 */
