...
public interface Monitor {
	 ...
	 *
	 * @return String - the name assigned to this instrumentation monitoring object
	 */
	String getName();
	 ...
	 *
	 * @return String - the base name of the name assigned to this instrumentation monitoring object.
	 */
	String getBaseName();
	 ...
	 *
	 * @return boolean - true if this instrumentation object is a vector type, false otherwise.
	 */
	boolean isVector();
	 ...
	 * 
	 * @return int - the length of the vector or zero if this instrumentation object is a scalar type.
	 */
	int getVectorLength();
