...
public class Variability implements java.io.Serializable {
	...
	/*
	 * The enumeration values for this typesafe enumeration must be kept in synchronization with the Variability enum in the perfData.hpp file in the HotSpot source base.
	 */
	...
	/**
	 * Maps an integer value its corresponding Variability attribute. If the integer value does not have a corresponding Variability enum value, the {@link Variability#INVALID} is returned
	 *
	 * @param value
	 *            an integer representation of a Variability attribute
	 * @return Variability - The Variability object for the given <code>value</code> or {@link Variability#INVALID} if out of range.
	 */
