...
public class HostIdentifier {
	 ...
	 *
	 * @param uriString
	 *            a string representing a target host. The syntax of the string must conform to the rules specified in the class documentation.
	 *
	 * @throws URISyntaxException
	 *             Thrown when the uriString or its canonical form is poorly formed. This exception may get encapsulated into a MonitorException in a future version.
	 *
	 */
	 ...
	 *
	 * @param scheme
	 *            the {@link URI#getScheme} component of a URI.
	 * @param authority
	 *            the {@link URI#getAuthority} component of a URI.
	 * @param path
	 *            the {@link URI#getPath} component of a URI.
	 * @param query
	 *            the {@link URI#getQuery} component of a URI.
	 * @param fragment
	 *            the {@link URI#getFragment} component of a URI.
	 *
	 * @throws URISyntaxException
	 *             Thrown when the uriString or its canonical form is poorly formed. This exception may get encapsulated into a MonitorException in a future version.
	 * @see URI
	 ...
	 *
	 * The necessary components of the VmIdentifier are extracted and reassembled into a HostIdentifier. If a "file:" scheme (protocol) is specified, the the returned HostIdentifier will always be equivalent to HostIdentifier("file://localhost").
	 *
	 * @param vmid
	 *            the VmIdentifier use to construct the HostIdentifier.
	 */
	...
	/**
	 * Resolve a VmIdentifier with this HostIdentifier. A VmIdentifier, such as <em>1234</em> or <em>1234@hostname</em> or any other string that omits certain components of the URI string may be valid, but is certainly incomplete. They are missing critical information for identifying the the communications protocol, target host, or other parameters. A VmIdentifier of this form is considered <em>unresolved</em>. This method uses components of the HostIdentifier to resolve the missing components
	 * of the VmIdentifier.
	 * <p>
	 * Specified components of the unresolved VmIdentifier take precedence over their HostIdentifier counterparts. For example, if the VmIdentifier indicates <em>1234@hostname:2099</em> and the HostIdentifier indicates <em>rmi://hostname:1099/</em>, then the resolved VmIdentifier will be <em>rmi://1234@hostname:2099</em>. Any component not explicitly specified or assumed by the HostIdentifier, will remain unresolved in resolved VmIdentifier.
	 * <p>
	 * A VmIdentifier specifying a <em>file:</em> scheme (protocol), is not changed in any way by this method.
	 *
	 * @param vmid
	 *            the unresolved VmIdentifier.
	 * @return VmIdentifier - the resolved VmIdentifier. If vmid was resolved on entry to this method, then the returned VmIdentifier will be equal, but not identical, to vmid.
	 */
	 ...
	 *
	 * @return String - the host part for this HostIdentifier, or "localhost" if the URI.getHost() returns null.
	 * @see URI#getUserInfo()
	 */
	 ...
	 * @return boolean - returns true if the given object is of type HostIdentifier and its URI field is equal to this object's URI field. Otherwise, returns false.
	 *
