...
public class VmStatusChangeEvent extends HostEvent {
	...
	/**
	 * Return the set of currently active Java Virtual Machines. The set contains an Integer object holding the <em>lvmid</em> for each active Java Virtual Machine on the MonitoredHost.
	 *
	...
	/**
	 * Return the set of Java Virtual Machines started since the last event notification. The set contains an Integer object holding the <em>lvmid</em> for each Java Virtual Machine started on the MonitoredHost since the last event notification.
	 *
	...
	/**
	 * Return the set of Java Virtual Machines terminated since the last event notification. The set contains an Integer object holding the <em>lvmid</em> for each Java Virtual Machine terminated on the MonitoredHost since the last event notification.
	 *
