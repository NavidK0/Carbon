...
public interface RemoteVm extends Remote {
	 ...
	 *
	 * @return byte[] - a byte array containing the current bytes for the instrumentation exported by the remote Java Virtual Machine.
	 ...
	 *
	 * @return int - the size of the instrumentation buffer for the remote Java Virtual Machine.
	 * @throws RemoteException
	 *             Thrown on any communication error
	 */
	...
	/**
	 * Interface to return the Local Virtual Machine Identifier for the remote Java Virtual Machine. The Local Virtual Machine Identifier is also know as the <em>lvmid</em>.
	 *
	 * @throws RemoteException
	 *             Thrown on any communication error
	 */
