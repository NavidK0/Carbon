...
public interface RemoteHost extends Remote {
	 ...
	 *             Thrown when any other error is encountered while communicating with the target virtual machine.
	...
	/**
	 * Remote method to detach from a remote HotSpot Java Virtual Machine identified by <code>vmid</code>.
	 *
	 * @param rvm
	 *            The remote object for the target Java Virtual Machine.
	 *
	 * @throws MonitorException
	 *             Thrown when any other error is encountered while communicating with the target virtual machine.
	 * @throws RemoteException
	...
	/**
	 * Get a list of Local Virtual Machine Identifiers for the active Java Virtual Machine the remote system. A Local Virtual Machine Identifier is also known as an <em>lvmid</em>.
	 *
