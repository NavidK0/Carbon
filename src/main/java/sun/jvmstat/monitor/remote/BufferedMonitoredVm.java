...
public interface BufferedMonitoredVm extends MonitoredVm {
	 ...
	 *
	 * @return byte[] - a byte array containing the current bytes for the instrumentation exported by the target Java Virtual Machine.
	 */
	byte[] getBytes();
	 ...
	 *
	 * @return int - the size of the instrumentation buffer for the target Java Virtual Machine.
	 */
	int getCapacity();
}
