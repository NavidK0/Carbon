...
public class Units implements java.io.Serializable {
	...
	/*
	 * The enumeration values for this typesafe enumeration must be kept in synchronization with the Units enum in the perfData.hpp file in the HotSpot source base.
	 */
	...
	/**
	 * Maps an integer value to its corresponding Units attribute. If the integer value does not have a corresponding Units enum value, then {@link Units#INVALID} is returned.
	 *
	 * @param value
	 *            an integer representation of counter Units
	 * @return Units - the Units object for the given <code>value</code> or {@link Units#INVALID} if out of range.
	 */
