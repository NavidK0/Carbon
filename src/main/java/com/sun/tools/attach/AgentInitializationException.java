 ...
 *
 * <p>
 * This exception is thrown by {@link com.sun.tools.attach.VirtualMachine#loadAgent VirtualMachine.loadAgent}, {@link com.sun.tools.attach.VirtualMachine#loadAgentLibrary VirtualMachine.loadAgentLibrary}, {@link com.sun.tools.attach.VirtualMachine#loadAgentPath VirtualMachine.loadAgentPath} methods if an agent, or agent library, cannot be initialized. When thrown by <tt>VirtualMachine.loadAgentLibrary</tt>, or <tt>VirtualMachine.loadAgentPath</tt> then the exception encapsulates the error
 * returned by the agent's <code>Agent_OnAttach</code> function. This error code can be obtained by invoking the {@link #returnValue() returnValue} method.
 */
public class AgentInitializationException extends Exception {
	...
	/**
	 * Constructs an <code>AgentInitializationException</code> with no detail message.
	 */
	...
	/**
	 * Constructs an <code>AgentInitializationException</code> with the specified detail message and the return value from the execution of the agent's <code>Agent_OnAttach</code> function.
	 *
	 * @param s
	 *            the detail message.
	 * @param returnValue
