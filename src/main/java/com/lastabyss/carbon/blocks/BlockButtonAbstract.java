...
public abstract class BlockButtonAbstract extends Block {
	...
	public boolean canPlace(World world, int i, int j, int k, int l) {
		return l == 0 && world.getType(i, j + 1, k).r() ? true : l == 1 && world.getType(i, j - 1, k).r() ? true : l == 2 && world.getType(i, j, k + 1).r() ? true : (l == 3 && world.getType(i, j, k - 1).r() ? true : (l == 4 && world.getType(i + 1, j, k).r() ? true : l == 5 && world.getType(i - 1, j, k).r()));
	}

	@Override
	public boolean canPlace(World world, int i, int j, int k) {
		return world.getType(i, j + 1, k).r() ? true : world.getType(i, j - 1, k).r() ? true : world.getType(i - 1, j, k).r() ? true : (world.getType(i + 1, j, k).r() ? true : (world.getType(i, j, k - 1).r() ? true : world.getType(i, j, k + 1).r()));
	}
	...
	public int getPlacedData(World world, int i, int j, int k, int l, float f, float f1, float f2, int i1) {
		...
		else if(l == 1 && world.getType(i, j - 1, k).r()) {
			j1 = 5;
		}
		else if(l == 2 && world.getType(i, j, k + 1).r()) {
			j1 = 4;
		}
	...
	public int c(IBlockAccess iblockaccess, int i, int j, int k, int l) {
		...
		if((i1 & 8) == 0) {
			...
			return j1 == 0 && l == 0 ? 15 : j1 == 5 && l == 1 ? 15 : (j1 == 4 && l == 2 ? 15 : (j1 == 3 && l == 3 ? 15 : (j1 == 2 && l == 4 ? 15 : (j1 == 1 && l == 5 ? 15 : 0))));
		}
	}
